...
namespace SSC.Net
{
    ...
    internal class IPArrayList
    {
        ...
        private List<object> ipNumList = new List<object>();
        private uint ipmask;
	...
	public class IPList
    {
        private List<object> ipRangeList = new List<object>();
        private SortedDictionary<object, object> maskList = new SortedDictionary<object, object>();
        private List<object> usedList = new List<object>();
        ...
        {
            this.Add(parseIP(ipNumber), (uint)maskList.FirstOrDefault(a1 => a1.Value == (object)maskLevel).Key);
        }
        ...
        public void AddRange(uint fromIP, uint toIP)
        {
            ...
            else
            {
                ...
                uint mask = (uint)maskList.FirstOrDefault(a1 => a1.Value == (object)diffLevel).Key;// .GetKey(maskList.IndexOfValue(diffLevel));
